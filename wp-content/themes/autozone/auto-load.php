        ...
        <div class="container">
                	...
                	<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 sticky-bar">
						<aside class="b-submit__aside">
							<div class="b-submit__aside-step step01 m-active">
								<h3><?php esc_html_e( 'Step 1', 'autozone' ); ?></h3>
								<div class="b-submit__aside-step-inner m-active clearfix">
									<div class="b-submit__aside-step-inner-icon">
										<span class="fa fa-car"></span>
									</div>
									<div class="b-submit__aside-step-inner-info">
										<h4><?php esc_html_e( 'Add your Vehicle', 'autozone' ); ?></h4>
										<p><?php esc_html_e( 'Select your vehicle and add info', 'autozone' ); ?></p>
							...
							<div class="b-submit__aside-step step02">
								<h3><?php esc_html_e( 'Step 2', 'autozone' ); ?></h3>
								...
								<div class="b-submit__aside-step-inner clearfix">
									...
									<div class="b-submit__aside-step-inner-info">
										<h4><?php esc_html_e( 'select details', 'autozone' ); ?></h4>
										<p><?php esc_html_e( 'Choose vehicle specifications', 'autozone' ); ?></p>
                                        <div class="b-submit__aside-step-inner-info-triangle"></div>
									</div>
								</div>
							...
							<div class="b-submit__aside-step step03">
								<h3><?php esc_html_e( 'Step 3', 'autozone' ); ?></h3>
								...
								<div class="b-submit__aside-step-inner clearfix">
									...
									<div class="b-submit__aside-step-inner-info">
										<h4><?php esc_html_e( 'Photos and videos', 'autozone' ); ?></h4>
										<p><?php esc_html_e( 'Add images / videos of vehicle', 'autozone' ); ?></p>
                                        <div class="b-submit__aside-step-inner-info-triangle"></div>
									</div>
								</div>
							...
							<div class="b-submit__aside-step step04">
								<h3><?php esc_html_e( 'Step 4', 'autozone' ); ?></h3>
								...
								<div class="b-submit__aside-step-inner clearfix">
									...
									<div class="b-submit__aside-step-inner-info">
										<h4><?php esc_html_e( 'Contact details', 'autozone' ); ?></h4>
										<p><?php esc_html_e( 'Vehicle Owner Details', 'autozone' ); ?></p>
                                        <div class="b-submit__aside-step-inner-info-triangle"></div>
									</div>
								</div>
							...
							<div class="b-submit__aside-step step05">
								<h3><?php esc_html_e( 'Step 5', 'autozone' ); ?></h3>
								...
								<div class="b-submit__aside-step-inner clearfix">
									...
									<div class="b-submit__aside-step-inner-info">
										<h4><?php esc_html_e( 'SUBMIT / PUBLISH', 'autozone' ); ?></h4>
										<p><?php esc_html_e( 'Submit Vehicle Info', 'autozone' ); ?></p>
                                        <div class="b-submit__aside-step-inner-info-triangle"></div>
									</div>
								</div>
           ...
           <div class="pixad-control-input col-md-8 col-sm-12 col-xs-12">
                    ...
                    <form enctype="multipart/form-data" method="post" action="<?php echo esc_url( $form_url );?>">
                       ...
                       <?php  get_template_part( 'templates/fields/auto-fields'); ?>
                        ...
                        <div class="pixad-form-group">
                            <label class="pixad-control-label">
                                <?php esc_html_e( 'Tipo de Vehículo', 'autozone' ); ?>
                            </label>
                    ...
                    <section class="step-section" id="step03">
                      <div class="col-md-12 col-xs-12" >
                        <div class="pixad-form-group">
                            <label class="pixad-control-label">
                                <?php esc_html_e( 'Main photo', 'autozone' ); ?>
                            </label>
                            <?php 
                            $manage_gallery = __('Manage gallery', 'autozone');
                            $clear_gallery  = __('Clear gallery', 'autozone');
                            if(is_user_logged_in()){
                             ...
                             <?php if (!empty($autos_demo_mode)): ?>
                                    <div class="pixad-autos">
                                        <span class="pixad-text-warning"><?php esc_attr_e('Uploading images is disabled in demo mode', 'autozone'); ?></span>
                                    </div>
                            <?php endif ?>
                        </div>

                        <div class="pixad-form-group">
                            <label class="pixad-control-label"><?php esc_html_e( 'Gallery photos', 'autozone' ); ?></label>
                            <div class="pixad-control-input">
                        ...
                        <div class="pixad-form-group">
                            ...
                            <div class="pixad-control-input">
                                <input type="text" class="regular-text pixad-form-control" placeholder="<?php esc_html_e( 'Please Enter A Hosted Video URL Of Your Vehicle', 'autozone' ); ?>" name="auto_video_code" id="auto_video_code" value="<?php echo esc_attr( $video); ?>">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="pixad-form-group">
                            ...
                            <div class="pixad-control-input">
                                <textarea name="content" placeholder="<?php esc_html_e( 'Car Info', 'autozone' ); ?>" class="pixad-form-control"></textarea>
                            </div>
