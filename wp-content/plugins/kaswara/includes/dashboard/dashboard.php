...
function kaswara_dashboard_menu(){
    ...
    //Add Submenu For The Demo Importer
    add_submenu_page(
        'kaswara-framework',
        esc_html__('Demo Importer','kaswara'),
        esc_html__('Demo Importer','kaswara'),
        'manage_options',
        'kaswara-demo-importer',
        'kaswara_demo_importer_render'
    );

    //Add Submenu Page For The Code Editor (CSS & JS)
    add_submenu_page(
        'kaswara-framework',
        esc_html__('Custom Settings','kaswara'),
        esc_html__('Custom Settings','kaswara'),
        'manage_options',
        'kaswara-custom-settings',
        'kaswara_custom_settings_render'
    );
...
<div class="kswr-dash-top" data-menu="hidden">
    <div class="kswr-dash-logo" data-situation="normal">
        <div class="kswr-dash-logo-loading"><div class="kswr-backend-loader"></div></div>
...
<div class="kswr-flow-menuicon" onclick="kswr_show_menu_popup(this);"><div class="kswr-flow-menuicon-insider"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></div></div>
<?php 
