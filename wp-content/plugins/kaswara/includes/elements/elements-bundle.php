...
function kaswara_custom_code_printer(){  ?>
<style type="text/css" media="screen"><?php echo stripcslashes(base64_decode(kaswara_get_single_option('customCSS'))); ?></style>
<style type="text/css" media="screen" data-type="ms-style"></style>
<script type="text/javascript"><?php echo stripcslashes(base64_decode(kaswara_get_single_option('customJS'))); ?></script>
<?php 
}
